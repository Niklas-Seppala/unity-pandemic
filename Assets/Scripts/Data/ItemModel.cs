...
{
    public class ItemModel : IDbModel
    {
        ...
        public void CreateFromRow(IDataReader reader)
        {
            ...
            this.Collected = Convert.ToBoolean(reader.GetInt32(4));
        ...
        public void SetInsertParameters(DbCommand dbCommand)
        {
            ...
            dbCommand.Parameters.Add(new SqliteParameter("$collected", Convert.ToInt32(this.Collected)));
        ...
        /// <summary>
        /// Convert Item to ItemModel transfering
        /// VARIABLE DATA.
        /// </summary>
        /// <param name="item"></param>
        public static explicit operator ItemModel(WorldItem item)
        {
